...
| ADR | Titre | Description | Date |
|-----|-------|-------------|------|
| [0012](a2a/0012-mock-data-sources-standalone.md) | **Clients et Produits de Test standalone** | Données de test intégrées (4 clients, 4 produits) | 2024-06-09 |
...
2024-06-09 (A2A 🆕 Nouvelle architecture)
  ...
  └── a2a/0012 - Clients et Produits de Test standalone
```
...
2. [ADR-0012: Clients et Produits de Test standalone](a2a/0012-mock-data-sources-standalone.md)

### Je veux déployer en production
➜ **Architecture Arena**
1. [ADR-0004: Architecture 3 agents orchestrée](arena/0004-architecture-3-agents-orchestree.md)
2. [ADR-0005: Agent acheteur intégré](arena/0005-agent-acheteur-integre.md)
